...
export const metadata: Metadata = {
  title: "I-balnik Dance School | Ballet, Contemporary & Hip-Hop Classes",
  description: "Professional dance instruction for all ages. Join I-balnik and discover ballet, contemporary, hip-hop, and jazz classes with experienced instructors in a supportive community.",
  keywords: ["dance school", "ballet classes", "contemporary dance", "hip-hop classes", "dance instruction", "professional choreography"],
  openGraph: {
    title: "I-balnik Dance School",
    description: "Professional dance instruction for all ages and skill levels. Ballet, contemporary, hip-hop, and jazz classes.",
    siteName: "I-balnik Dance School",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1764937049543-7bdoou7r.jpg",
        alt: "I-balnik Dance School - Professional dancers",
      },
    ],
    type: "website",
  },
